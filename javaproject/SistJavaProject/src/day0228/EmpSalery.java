...
class Emp{
	...
	//멤버: 사원명(name)  기본급(pay) 가족수(famSu) 초과근무시간(timeSu) 
	//메서드: setters & getters     getFamSudang, getTimeSudang, getTotalay
	...
	//가족수당..가족한명당 5만원(단4인이상은 무조건 20만원으로 통일)
	...
	//오버타임수당..시간당 근무수당 = 초과시간당 3만원 (단10시간 이상은 무조건 30만원)
