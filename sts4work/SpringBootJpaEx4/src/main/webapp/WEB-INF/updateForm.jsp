...
<form action="update" method="post">
	...
	<caption align="top"><b>음식수정폼</b></caption>
		<tr>
			<th>음식이름</th>
			<td>
				<input type="text" class="form-control" name="foodname" value="${dto.foodname }">
			</td>
		</tr>
		<tr>
			<th>음식가격</th>
			<td>
				<input type="text" class="form-control" name="foodprice" value="${dto.foodprice }">
			</td>
		</tr>
		<tr>
			<th>음식사진</th>
